...
\section{Prelude}
\label{sec:org12282f8}

\begin{frame}[label={sec:org6e018a3}]{Hello, World}
\begin{itemize}
...
\begin{minted}[frame=lines,fontsize=\scriptsize,linenos=false]{yaml}
library
  hs-source-dirs:      src
...
\begin{frame}[label={sec:orgd75d3ab}]{That's Not All}
...
\begin{frame}[label={sec:org8938577}]{That's No Side Effect}
\begin{center}
\includegraphics[height=0.6\textheight]{./img/no-side-effects.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf3d6a09},fragile]{That's No Side Effect}
...
\begin{frame}[label={sec:org080013e},fragile]{To \alert{\texttt{do}} List}
...
\begin{frame}[label={sec:org660a683}]{Back to HCat}
\begin{center}
...
\begin{frame}[label={sec:orga6d91a0},fragile]{Pagination}
...
\begin{frame}[label={sec:orgec878a0}]{The Event Loop}
...
\begin{frame}[label={sec:orge8941e1},fragile]{Getting User Input}
 \begin{minted}[frame=lines,fontsize=\scriptsize,linenos=false]{haskell}
data ContinueCancel
  = Continue
  | Cancel
...
\begin{frame}[label={sec:org9e4674f},fragile]{Taking User Input for a Loop}
...
\begin{frame}[label={sec:org2035f01},fragile]{Recursive IO Actions}
...
\begin{frame}[label={sec:org9440f96}]{Continued Action}
...
\begin{frame}[label={sec:org36dc2ff},fragile]{Continued Action}
