...
\section{Prelude}
\label{sec:org67c5b58}

\begin{frame}[label={sec:org128bab2}]{Hello, World}
\begin{itemize}
...
\begin{frame}[label={sec:orge9e9a24}]{About This Talk}
\begin{columns}
...
\begin{frame}[label={sec:org93869df}]{Effective Haskell}
\begin{columns}
\begin{column}[t]{0.45\columnwidth}
\begin{center}
...
\label{sec:orge85bcd0}

\begin{frame}[label={sec:orgb12d12d}]{Build Your Tools!}
\begin{center}
\includegraphics[height=0.7\textheight]{img/build-your-own-tools.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orge1fe100}]{HCat: A Haskell Pager}
...
\begin{frame}[label={sec:orgb934aad}]{HCat: A Screenshot}
\begin{center}
\includegraphics[height=0.8\textheight]{img/hcat-screen.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6e107de}]{Re-Inventing a Thousand Wheels}
...
\begin{frame}[label={sec:org1411c5c}]{Choosing Haskell for Developer Tooling}
...
\label{sec:orgba53ea2}

\begin{frame}[label={sec:org4b457c2}]{Setting Up Your Environment}
\begin{center}
\includegraphics[height=0.8\textheight]{img/environment.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org61758fc}]{Operating System}
...
\begin{frame}[label={sec:org21c0dd9}]{Operating System}
\begin{center}
\includegraphics[height=0.5\textheight]{img/windows.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org67b3bd6}]{Installing Haskell}
...
\begin{frame}[label={sec:org775c3f9}]{Configuring Your Editor}
...
\begin{frame}[label={sec:orge23ff8e}]{Linting}
...
\begin{frame}[label={sec:orgadd2e3d}]{Pretty Printing}
...
\begin{frame}[label={sec:org76b853b}]{Too Much Text}
\begin{center}
\includegraphics[height=0.8\textheight]{img/tools.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org158067e}]{IDEs and Not-IDEs}
...
\begin{frame}[label={sec:orgae2399d}]{Picking a GHC Version}
\begin{itemize}
...
\label{sec:org2c878fc}

\begin{frame}[label={sec:orgf863fa4}]{Browse Documentation on Hackage}
...
\begin{frame}[label={sec:orgea9048a}]{Browse Documentation on Hackage}
\url{img/hackage-demo.webm}
\end{frame}

\begin{frame}[label={sec:orgb739389}]{Search Libraries with Hoogle}
\url{img/hoogle-demo.webm}
\end{frame}

\section{Starting a New Project}
\label{sec:orgdd6bd5c}

\begin{frame}[label={sec:org6f9bff3}]{Starting a New Project}
\begin{center}
\includegraphics[height=0.8\textheight]{img/project.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2f8f6a3},fragile]{Haskell Packaging Overview}
...
\begin{frame}[label={sec:orgfaeea18}]{Picking a Build Tool}
...
\begin{frame}[label={sec:orgb157299},fragile]{Cabal Basics}
 \begin{description}
...
\begin{frame}[label={sec:orgc9f8405},fragile]{The Cabal File}
 \begin{verbatim}
cabal-version:       2.4
name:                hcat
version:             0.1.0.0
...
\begin{frame}[label={sec:org44343cb},fragile]{App, Src, and Test}
 \begin{itemize}
...
\begin{frame}[label={sec:org27c3a58}]{Managing Dependencies}
...
\label{sec:org82974cd}

\begin{frame}[label={sec:org8cfe94e},fragile]{Read File, Write File}
...
\begin{frame}[label={sec:org2d10ac5},fragile]{Read File, Write File}
...
\begin{frame}[label={sec:orgbfc48b6}]{Read File, Write File}
The lesson:
...
\begin{frame}[label={sec:org286a5ac}]{Zoom, Enhance, Refactor}
\begin{center}
\includegraphics[height=0.8\textheight]{img/refactoring.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6aff8a4},fragile]{Zoom, Enhance, Refactor}
...
\label{sec:org18ff1a9}

\begin{frame}[label={sec:orgc15ba5c}]{A Tale of Two Languages}
...
\begin{frame}[label={sec:orge3c6803},fragile]{A Tale of Two Languages}
 \begin{columns}
\begin{column}[t]{0.45\columnwidth}
...
\begin{frame}[label={sec:orgab5cce2},fragile]{A Tale of Two Languages}
 \begin{columns}
\begin{column}[t]{0.45\columnwidth}
...
\begin{frame}[label={sec:orgd54a88d}]{We put code in your code}
...
\begin{frame}[label={sec:org9877880}]{How \alert{do} you \alert{do} it?}
...
\begin{frame}[label={sec:org3ebbf00},fragile]{How \alert{do} you \alert{do} it?}
...
\begin{frame}[label={sec:org3e14907}]{Slings and Arrows}
...
\begin{frame}[label={sec:org1b48c37},fragile]{Slings and Arrows}
 \begin{minted}[frame=lines,fontsize=\scriptsize,linenos=false]{haskell}
