...
\mode<presentation> {\usetheme{bjeldbak}}
...
\begin{frame}
  \begin{itemize}
    \item twitter: \underline{\color{blue} \href{https://twitter.com/cercerilla}{@cercerilla}}
    \item sample code: \underline{\color{blue} \url{https://github.com/rebeccaskinner/agile17-sample}}
    \item reference library: \underline{\color {blue} \url{https://github.com/asteris-llc/gofpher}}
    \item slides: <TBD>
  \end{itemize}
\end{frame}
